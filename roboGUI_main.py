...
root.title("Object Detection and display Count Using Machine Learning")

# 43

# ++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 = Image.open('miltry robot1.jpg')
...
#
label_l1 = tk.Label(root, text="Object Detection and display Count Using Machine Learning",font=("Times New Roman", 35, 'bold'),
...
def reg():
    from subprocess import call
    call(["python","robo_registration.py"])

def log():
    from subprocess import call
    call(["python","robo_login.py"])
